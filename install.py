...
for filename in map(Path, ["pyproject.toml", "_README.md", "Dockerfile", "src/dashboard-skeleton/__main__.py", "src/dashboard-skeleton/pages/index.py", "src/dashboard-skeleton/assets/config.yaml"]):
